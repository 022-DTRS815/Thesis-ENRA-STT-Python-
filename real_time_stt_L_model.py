...
# Increased CHUNK size to handle potential buffer overflows from a larger model
# A larger chunk gives the CPU more time to process the audio between reads.
...
try:
    ...
    print("This is likely caused by an audio device issue or a buffer overflow.")
    print("Please check your microphone and try restarting the program.")
except KeyboardInterrupt:
    print("\nStopping...")
finally:
    # This check ensures we only try to close the stream if it's still open
